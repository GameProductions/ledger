...
export const VERSION_UPDATES = [
  ...
  { version: 'v6.1.0', title: 'Security Overhaul', description: 'Complete security standard unification across all apps. Decommissioned legacy TOTP in favor of secure WebAuthn Passkeys. Implemented biometric step-up authentication for all administrative actions and finalized the zero-knowledge identity vault.' },
