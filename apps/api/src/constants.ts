export const CURRENT_VERSION = 'v3.11.4'

export const VERSION_UPDATES = [
  { version: 'v3.11.4', title: 'Total Modernization', description: 'Complete elimination of legacy routing and transition to a standardized modular architecture.' },
