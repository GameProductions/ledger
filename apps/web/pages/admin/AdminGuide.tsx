      ...
      <div className="max-w-7xl mx-auto space-y-12 pb-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <p className="text-sm text-slate-500 tracking-[0.3em] font-bold">System Documentation</p>
          ...
          <div className="flex items-center gap-4 p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
             ...
             <div className="flex flex-col">
                <span className="text-xs font-black text-slate-500">Documentation Count</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 min-h-[600px]">
           ...
           <div className="lg:col-span-4 space-y-4">
              <div className="flex items-center gap-2 px-1 mb-6">
                 ...
                 <span className="text-xs font-black tracking-widest text-slate-500">Table of Contents</span>
              </div>
                  ...
                  {walkthroughs.map((w) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <h4 className="text-lg font-black text-white italic group-hover:text-emerald-400 transition-colors">
                          {w.title}
                        </h4>
                      </div>
                    </button>
              ...
              {selectedWalkthrough ? (
                ...
                <div className="h-full rounded-[2.5rem] border border-dashed border-white/10 flex flex-col items-center justify-center p-12 text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-black text-white italic">Awaiting Selection</h3>
        ...
        <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-blue-500/10 via-transparent to-emerald-500/10 border border-white/5 space-y-8 relative overflow-hidden">
            <div className="flex items-center gap-4 text-emerald-500">
               ...
               <h3 className="text-2xl font-black tracking-tighter italic">System Procedures</h3>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
               <div className="p-6 bg-black/40 rounded-2xl border border-white/5 space-y-3">
                  <div className="text-xs font-black text-slate-500 tracking-widest">Auth_01</div>
                  <h4 className="text-sm font-bold text-white">Passkey Removal</h4>
               ...
               <div className="p-6 bg-black/40 rounded-2xl border border-white/5 space-y-3">
                  <div className="text-xs font-black text-slate-500 tracking-widest">Cred_02</div>
                  <h4 className="text-sm font-bold text-white">Temp Baseline</h4>
               ...
               <div className="p-6 bg-black/40 rounded-2xl border border-white/5 space-y-3">
                  <div className="text-xs font-black text-slate-500 tracking-widest">Asset_03</div>
                  <h4 className="text-sm font-bold text-white">Asset Persistence</h4>
                  <p className="text-sm text-slate-500 leading-relaxed">Determines if synced avatars are retained after unlinking accounts.</p>
               </div>
               <div className="p-6 bg-black/40 rounded-2xl border border-white/5 space-y-3">
                  <div className="text-xs font-black text-slate-500 tracking-widest">Logs</div>
                ...
                <div className="p-6 bg-black/40 rounded-2xl border border-white/5 space-y-3 shadow-xl hover:border-purple-500/30 transition-all group/card">
                  <div className="text-xs font-black text-slate-500 tracking-widest group-hover/card:text-purple-400">Access_05</div>
                  <h4 className="text-sm font-bold text-white">Account Access Tracking</h4>
