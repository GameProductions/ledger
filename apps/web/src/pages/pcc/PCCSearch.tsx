...
const PCCSearch: React.FC = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${apiUrl}/api/pcc/search?q=${encodeURIComponent(query)}`, {
      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSearch} className="relative mb-12">
          <input 
            ...
            placeholder="Search across users, billers, and registries..."
          ...
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section>
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-500 mb-6 flex items-center gap-4">
                User Matches <div className="h-[1px] flex-1 bg-emerald-500/20" />
              </h3>
