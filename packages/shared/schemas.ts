...
export const InstallmentPlanSchema = z.object({
  ...
  upcomingAmountCents: z.number().int().nonnegative().optional(),
...
export const SubscriptionSchema = z.object({
  ...
  maxOccurrences: z.number().int().nonnegative().optional().nullable(),
  accountId: z.string().optional(),
  paymentMode: z.enum(['manual', 'autopay']).optional(),
  ownerId: z.string().optional(),
...
export const PayScheduleSchema = z.object({
  ...
  estimatedAmountCents: z.number().int().nonnegative().optional().nullable(),
  notes: z.string().max(1000).optional().nullable(),
...
export const BillSchema = z.object({
  ...
  status: z.enum(['unpaid', 'paid', 'cancelled', 'pending']).optional().default('unpaid'),
  notes: z.string().max(1000).optional().nullable(),
  categoryId: z.string().optional().nullable(),
...
export const CreditCardSchema = z.object({
  accountId: z.string(),
  creditLimitCents: z.number().int().nonnegative().optional().default(0),
