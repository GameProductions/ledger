    ...
    <MainLayout>
      <div className="max-w-5xl mx-auto py-12 space-y-12">
        <header className="space-y-4">
          <div className="text-xs font-black tracking-[0.4em] text-primary mb-2">Show Me How</div>
          ...
          {(tours || []).map((tour, i) => (
            <div key={i} className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6 flex flex-col justify-between group">
              ...
              <button 
                ...
                className="flex items-center gap-3 px-6 py-4 bg-white/5 hover:bg-white text-secondary hover:text-black rounded-2xl text-xs font-black tracking-widest transition-all"
              >
