...
export const GlassFooter: React.FC = () => {
  ...
  const version = import.meta.env.PACKAGE_VERSION || import.meta.env.VITE_APP_VERSION || '3.160.2';
    ...
    <>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full bg-slate-900/80 border border-orange-500/30 text-orange-400 font-semibold tracking-wider shadow-sm">
                  {formattedVersion}
                </span>
              </div>
              <p className="text-xs font-bold tracking-[0.2em] text-orange-500/60">Live Evaluation of Daily Gains & Expense Records</p>
            </div>
          </div>
          
          <div className="flex items-center gap-2 px-3 py-1.5 bg-black/40 border border-white/5 rounded-full w-fit">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[11px] font-bold tracking-widest text-emerald-500/80">System Operational</span>
          </div>
        </div>

        <div className="grid grid-cols-2 md:flex md:items-center gap-x-12 gap-y-6">
          <div className="space-y-3">
            <h5 className="text-xs font-bold tracking-widest text-white/40">Resources</h5>
          ...
          <div className="space-y-3">
            <h5 className="text-xs font-bold tracking-widest text-white/40">Legal & Trust</h5>
            <ul className="space-y-2">
              <li><a href="/legal/privacy" className="text-xs font-bold text-secondary hover:text-orange-500 transition-colors">Privacy Policy</a></li>
              <li><a href="/legal/terms" className="text-xs font-bold text-secondary hover:text-orange-500 transition-colors">Terms of Service</a></li>
              <li><a href="/legal/security" className="text-xs font-bold text-secondary hover:text-orange-500 transition-colors">Security</a></li>
              <li><a href="/legal/safety" className="text-xs font-bold text-secondary hover:text-orange-500 transition-colors">Safety</a></li>
              <li>
                <button 
                  onClick={openCookiePreferences} 
                  className="text-xs font-bold text-secondary hover:text-orange-500 transition-colors text-left"
                >
                  Cookie Preferences
                </button>
              </li>
      ...
      <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 bg-white/5 rounded-lg border border-white/5">
          ...
          <span className="text-[11px] font-bold tracking-widest text-white/30">End-to-End Encrypted Ledger</span>
        </div>
      </div>
    </>
  );
  ...
  return reduced ? (
    <footer className="mt-24 pb-12 px-8">
      {content}
    </footer>
  ) : (
    <motion.footer
