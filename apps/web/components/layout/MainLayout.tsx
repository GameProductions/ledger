  ...
  return (
    <div className={`min-h-screen flex flex-col transition-all duration-700 ${isLuxury ? 'bg-luxury-grid' : ''}`}>
      ...
      <main className={`flex-1 w-full transition-all duration-700 ${
        isLuxury ? 'max-w-5xl mx-auto px-4 sm:px-8 pt-4 sm:pt-40 pb-28 sm:pb-24' : 
        isBusiness ? 'max-w-[100vw] px-3 sm:px-6 pt-4 sm:pt-28 pb-20 sm:pb-12 flex flex-col sm:flex-row sm:space-x-8' : 
        'max-w-7xl mx-auto px-3 sm:px-4 pt-4 sm:pt-32 pb-24 sm:pb-16'
      }`}>
        {isBusiness && (
