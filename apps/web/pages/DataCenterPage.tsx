        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="p-1 bg-white/5 rounded-2xl border border-white/10 flex gap-1">
             <button 
               ...
               className={`flex items-center gap-2 px-6 py-3 rounded-xl font-black text-xs transition-all ${importScope === 'private' ? 'bg-emerald-500 text-black shadow-xl' : 'text-slate-500 hover:text-white'}`}
             >
               <Lock size={14} /> Just for Me
             </button>
             <button 
               onClick={() => setImportScope('household')}
               className={`flex items-center gap-2 px-6 py-3 rounded-xl font-black text-xs transition-all ${importScope === 'household' ? 'bg-white text-black shadow-xl' : 'text-slate-500 hover:text-white'}`}
             >
              ...
              <div className="flex border-b border-white/10 p-2">
                {[
                  ...
                  <button 
                    ...
                    className={`flex-1 flex items-center justify-center gap-3 py-5 rounded-2xl font-black text-xs tracking-widest transition-all ${activeTab === tab.id ? 'bg-white/5 text-white' : 'text-slate-600 hover:text-slate-400'}`}
                  >
              ...
              <div className="p-12">
                ...
                {activeTab === 'cloud' && (
                  <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500 py-12 text-center">
                    ...
                    <h3 className="text-2xl font-black text-white italic tracking-tighter">Remote Storage Sync</h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 max-w-md mx-auto pt-8">
                       {[
                         ...
                         >
                            <div className="aspect-square w-full rounded-2xl bg-black/40 mb-3 flex items-center justify-center font-bold text-xs group-hover:scale-105 transition-all">
                ...
                {activeTab === 'url' && (
                  <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
                    <div className="p-8 rounded-3xl bg-white/5 border border-white/5">
                       <h3 className="text-xl font-bold mb-4 flex items-center gap-2 italic tracking-tight"><Globe className="text-emerald-500" /> Smart Web Scraper</h3>
                       ...
                       <div className="flex gap-4">
                          ...
                          <button 
                            ...
                            disabled={scanning}
                            className="px-8 py-4 bg-emerald-500 text-black font-black text-sm rounded-2xl hover:scale-105 transition-all shadow-xl shadow-emerald-500/20 disabled:opacity-50"
                          >
                      ...
                      <div className="p-8 rounded-[2.5rem] bg-emerald-500/5 border border-emerald-500/10 animate-in slide-in-from-top-4 duration-500 flex gap-8 items-center">
                         ...
                         <div className="flex-1">
                            ...
                            <div className="flex gap-4 mt-6">
                                <button className="px-6 py-2 bg-emerald-500 text-black font-bold text-xs rounded-lg hover:bg-emerald-400 transition-all">Import to {importScope === 'household' ? 'Shared List' : 'Private Hub'}</button>
                                <button onClick={() => setScanResult(null)} className="px-6 py-2 bg-white/5 text-white font-bold text-xs rounded-lg hover:bg-white/10 transition-all">Discard</button>
                            </div>
                         </div>
                      </div>
                    )}
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 rounded-[3rem] bg-gradient-to-br from-blue-500/10 via-transparent to-transparent border border-white/10 backdrop-blur-xl relative overflow-hidden group">
               ...
               <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h2 className="text-xl font-black tracking-widest text-blue-500">Download Records</h2>
                  ...
                  {[
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs font-bold tracking-widest text-slate-500">Format: {item.format}</p>
                      </div>
            ...
            <div className="p-8 rounded-[3rem] bg-emerald-500/5 border border-emerald-500/10">
               <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-sm font-black tracking-widest">Privacy Shield</h3>
               </div>
