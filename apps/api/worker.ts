...
app.use("*", secureHeaders({
  contentSecurityPolicy: {
      ...
      scriptSrc: ["'self'", "https://static.cloudflareinsights.com", "'sha256-jlsMk0YHlcRfVk3Qperx5kMvCH97KaEu4osmzX3GsuY='", "'sha256-InQKS/0eWsccv2yFQ9tVKWenXws5ak8p0SLxqqKNed0='"],
