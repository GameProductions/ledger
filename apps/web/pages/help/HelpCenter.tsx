    ...
    <MainLayout>
      <div className="max-w-6xl mx-auto space-y-16 py-12">
        <header className="text-center space-y-4">
          <div className="text-xs font-black tracking-[0.4em] text-primary mb-4 opacity-70">Support Center</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm font-black tracking-widest text-primary group-hover:gap-4 transition-all">
