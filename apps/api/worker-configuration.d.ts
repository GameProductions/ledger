/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 344e86db6d5816c919ed5be9153f86b3)
// Runtime types generated with workerd@1.20260317.1 2024-03-22 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HouseholdSession" | "Vault" | "RateLimiter";
	}
	interface Env {
		ASSETS: R2Bucket;
		DB: D1Database;
		...
		METHOD_API_KEY: string;
		AKOYA_CLIENT_ID: string;
		AKOYA_SECRET: string;
		RESEND_API_KEY: string;
		SESSION: DurableObjectNamespace<import("./src/index").HouseholdSession>;
		VAULT: DurableObjectNamespace<import("./src/index").Vault>;
