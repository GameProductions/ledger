      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm font-bold tracking-tight">
          <div className="flex items-center space-x-4">
            <span className="text-white tracking-widest text-[10px]">
              {appName}
            </span>
          ...
          <div className="flex items-center space-x-8 text-slate-500 tracking-widest text-[10px]">
        ...
        <div className="pt-8 border-t border-slate-900/50 flex justify-center">
          <p className="text-slate-600 text-[10px] font-bold tracking-[0.2em]">
