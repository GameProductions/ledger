    ...
    <footer className="mt-24 pb-12 px-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold tracking-widest text-secondary">v{import.meta.env.VITE_APP_VERSION || '1.0.0'}</span>
              </div>
        ...
        <div className="grid grid-cols-2 md:flex md:items-center gap-x-12 gap-y-6">
          ...
          <div className="space-y-3">
            <h5 className="text-xs font-bold tracking-widest text-white/40">Legal</h5>
            <ul className="space-y-2">
      ...
      <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-xs font-bold tracking-[0.2em] text-white/20">
