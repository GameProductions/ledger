...
export const FIELD_DEFS: Record<EntityType, FieldDef[]> = {
  ...
  bills: [
    ...
    { key: 'payScheduleId', label: 'Pay Schedule', type: 'text', placeholder: 'UUID (optional)', reference: { apiPath: '/api/planning/pay-schedules', labelKey: 'name' } },
    ...
    { key: 'externalContactId', label: 'External Contact', type: 'text', placeholder: 'UUID (optional)' },
  ...
  'credit-cards': [
    { key: 'householdId', label: 'Household ID', type: 'text', locked: true },
    { key: 'accountId', label: 'Linked Account', type: 'text', placeholder: 'UUID', reference: { apiPath: '/api/financials/accounts', labelKey: 'name' } },
  ...
  'linked-accounts': [
    ...
    { key: 'householdId', label: 'Household ID', type: 'text', locked: true },
    { key: 'providerId', label: 'Provider', type: 'text', reference: { apiPath: '/api/user/service-providers', labelKey: 'name' } },
    { key: 'paymentMethodId', label: 'Payment Method', type: 'text', placeholder: 'UUID (optional)', reference: { apiPath: '/api/user/payment-methods', labelKey: 'name' } },
    ...
    { key: 'subscriptionId', label: 'Subscription', type: 'text', placeholder: 'UUID (optional)', reference: { apiPath: '/api/planning/subscriptions', labelKey: 'name' } },
  ...
  'pairing-rules': [
    ...
    { key: 'targetProviderId', label: 'Target Provider', type: 'text', placeholder: 'UUID (optional)', reference: { apiPath: '/api/user/service-providers', labelKey: 'name' } },
    { key: 'targetCategoryId', label: 'Target Category', type: 'text', placeholder: 'UUID (optional)', reference: { apiPath: '/api/financials/categories', labelKey: 'name' } },
  ...
  lenders: [
    ...
    { key: 'householdId', label: 'Household ID', type: 'text', locked: true },
    { key: 'billingProcessorId', label: 'Billing Processor', type: 'text', placeholder: 'UUID (optional)' },
    { key: 'billerId', label: 'Biller', type: 'text', placeholder: 'UUID (optional)' },
