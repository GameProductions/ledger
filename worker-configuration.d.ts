/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3f95077cf6b194e70e9612a72c61a077)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/api/worker");
	...
	interface Env {
		...
		FROM_EMAIL: "LEDGER <onboarding@resend.dev>";
		WEB_URL: "https://ledger.gpnet.dev";
		GIT_REPO: "https://github.com/GameProductions/ledger";
		VITE_API_URL: string;
		JWT_SECRET: string;
		RP_ID: string;
		RP_NAME: string;
		SESSION: DurableObjectNamespace<import("./apps/api/worker").HouseholdSession>;
		VAULT: DurableObjectNamespace<import("./apps/api/worker").Vault>;
		RECONCILIATION_AGENT: DurableObjectNamespace<import("./apps/api/worker").ReconciliationAgent>;
		MATCH_AGENT: DurableObjectNamespace<import("./apps/api/worker").MatchAgent>;
		RULE_AGENT: DurableObjectNamespace<import("./apps/api/worker").RuleAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "ENVIRONMENT" | "FROM_EMAIL" | "WEB_URL" | "GIT_REPO" | "VITE_API_URL" | "JWT_SECRET" | "RP_ID" | "RP_NAME">> {}
}
...
declare namespace CloudflareWorkersModule {
    ...
    export interface StepPromise<T> extends Promise<T> {
        ...
        rollback(config: WorkflowStepConfig, fn: (ctx: RollbackContext<T>) => Promise<void>): StepPromise<T>;
    }
    export abstract class WorkflowStep {
        do<T extends Rpc.Serializable<T>>(name: string, callback: (ctx: WorkflowStepContext) => Promise<T>): StepPromise<T>;
        do<T extends Rpc.Serializable<T>>(name: string, config: WorkflowStepConfig, callback: (ctx: WorkflowStepContext) => Promise<T>): StepPromise<T>;
