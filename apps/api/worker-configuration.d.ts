/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 254401d0b0fe728c010f0a026a6d0a28)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		RP_ID: string;
		RP_NAME: string;
		SESSION: DurableObjectNamespace<import("./worker").HouseholdSession>;
		VAULT: DurableObjectNamespace<import("./worker").Vault>;
		RECONCILIATION_AGENT: DurableObjectNamespace<import("./worker").ReconciliationAgent>;
		MATCH_AGENT: DurableObjectNamespace<import("./worker").MatchAgent>;
		RULE_AGENT: DurableObjectNamespace<import("./worker").RuleAgent>;
	}
}
