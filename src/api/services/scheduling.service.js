import { addDays, addMonths, addYears, parseISO, setDate } from 'date-fns';
...
export class SchedulingService {
     ...
     */
    static calculateNextOccurrence(schedule, fromDate = new Date(), currentExecutionCount = 0) {
     ...
     */
    static shouldExecute(schedule, now = new Date()) {
