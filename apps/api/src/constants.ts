export const CURRENT_VERSION = 'v3.11.2'

export const VERSION_UPDATES = [
  { version: 'v3.11.2', title: 'Total Modernization', description: 'Complete elimination of legacy routing and transition to a standardized modular architecture.' },
