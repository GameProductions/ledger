/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0e310526c1139643b99074e0531913d)
// Runtime types generated with workerd@1.20260424.1 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		FOUNDATION_URL: "https://foundation.gpnet.dev";
		GIT_REPO: "https://github.com/GameProductions/ledger";
		VITE_API_URL: string;
		SESSION: DurableObjectNamespace<import("./server").HouseholdSession>;
		VAULT: DurableObjectNamespace<import("./server").Vault>;
	}
}
